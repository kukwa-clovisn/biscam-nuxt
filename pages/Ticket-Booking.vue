            ...
            <div class="ticket-container">
                <div class="ticket-wrapper">
                    ...
                    <form @submit="event.preventDefault()">
                        ...
                        <div class="form-wrapper" v-if="stepOne">
                            <div class="form-data">
                                ...
                                <div class="form-input">
                                    <label for="departure"><i class="fa-solid fa-plane"></i></label> <input name="departure"
                            ...
                            <div class="form-data">
                                ...
                                <div class="form-input">
                                    ...
                                    <input type="number" name="passangers" min="1" id="passangers"
                                        placeholder="Departure Date" />
                                </div>
                            </div>
                        </div>
                        ...
                        <el-button style="margin-top: 12px" @click="next" v-if="stepOne" class="form-button">Next
                            step <i class="fa-solid fa-forward"></i></el-button>
                        <el-button style="margin-top: 12px" @click="next" v-if="stepTwo" class="form-button">Next
                            step <i class="fa-solid fa-forward"></i></el-button>
                        <el-button style="margin-top: 12px" @click="next" v-if="confirm" class="form-button">confirm
                            booking <i class="fa-solid fa-circle-check"></i></el-button>
                    </form>
                </div>
...
export default {
    ...
    setup() {
        ...
        return {
            next, active, stepOne, stepTwo, confirm
        }
    }
}
</script>
